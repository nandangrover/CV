class resume {
  ...
  loadJSON() {
    this.createElement({ className: 'heading', id: `resume-editor`, appendTo: 'main', type: 'h1', html: "Enter your name to load previously loaded resumes or create new ones" });

    this.createElement({ className: 'info-holder', id: `info-holder`, appendTo: 'main' });
